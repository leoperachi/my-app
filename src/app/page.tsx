            ...
            <div className="content-center" style={{marginTop: '3px', marginBottom: '2px'}}>
              <div className="p-5 justify-center items-center" style={{backgroundColor: '#1f1f1f'}}>
                <div className="flex justify-center items-center">
                  <Image width={200} height={300} src="/leo-prof.jpg" alt="teste" className="imgSm" style={{height: '40vh', width: '250px', backgroundImage: 'url("./leo-prof.jpg")', backgroundSize: 'cover', backgroundPosition: 'center', borderRadius:'15px', marginBottom: '15px' }}></Image>
                </div>
            ...
            <div className="content-center overflow-auto" style={{marginTop: '3px', marginBottom: '2px'}}>
              <div className="p-5" style={{backgroundColor: '#1f1f1f'}}>
                <div className="flex flex-wrap">
                  ...
                  <Image src="/puc.jpg" alt={"leo"} width={100} height={100} style={{borderRadius:'75px'}}></Image>
                  ...
                  <div className="flex-initial w-64  mr-5">
                    <Image src="/senac.png" alt={"leo"} width={100} height={100} style={{borderRadius:'25px'}}></Image>
                    <h2 className="text-xl">Assembly and Maintenance of Computers</h2>
                    <p>SENACRS</p>
                    <p>05/2008</p>
                  </div>
                  <div className="flex-initial w-64">
                    <Image src="/ih.png" alt={"leo"} width={150} height={150} style={{borderRadius:'25px', marginBottom: 40}}></Image>
